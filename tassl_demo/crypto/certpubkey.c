 ...
 * ------------------------------------------------------------ */
//gcc -ggdb3 -O0 -o certpubkey certpubkey.c -I${INC_DIR} -I/media/mathews/LENOVO/orchastack/dev/sm-workspace/TASSL-1.1.1b/crypto/include -I/media/mathews/LENOVO/orchastack/dev/sm-workspace/TASSL-1.1.1b/include  ${LIB_DIR}/libssl.a ${LIB_DIR}/libcrypto.a  -ldl -lpthread
...
int main() {
  ...
  const char cert_filestr[] = "../cert/certs/CE.pem";
             EVP_PKEY *pkey = NULL;
  BIO              *certbio = NULL;
  BIO               *outbio = NULL;
  X509                *cert = NULL;
